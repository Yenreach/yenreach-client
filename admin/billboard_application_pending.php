                        ...
                        <div class="card-body card-block">
                            ...
                            <p>
                                <table class="table table-striped table-bordered table-responsive-sm text-dark">
                                    ...
                                    <tr>
                                        <th scope="row">Already scheduled Adverts</th>
                                        <td><?php echo $application->scheduled_total; ?></td>
                                    </tr>
                                </table>
                            </p>
                            <p>
                                <a href="billboard_application_approve?<?php echo $application->verify_string; ?>" class="btn btn-success my-3 mx-auto"
                                onclick="return confirm('Do you really want to approve this Application?')">Approve</a>
                                <a href="billboard_application_revert?<?php echo $application->verify_string; ?>" class="btn btn-warning my-3 mx-auto">Revert</a>
                                <a href="billboard_application_reject?<?php echo $application->verify_string; ?>" class="btn btn-danger my-3 mx-auto"
                                onclick="return confirm('Do you really want to reject this Application?')">Reject</a>
                            </p>
                        </div>
                    </div>
                </div>
