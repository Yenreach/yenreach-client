    ...
    if($applications){
        if($applications->status == "success"){
            ...
            if(isset($_POST['submit'])){
                ...
                $purl = "revert_billboard_application_api.php";
                $pdata = [
                ...
                if($reverts){
                    if($reverts->status == "success"){
                        ...
                        $lpdata = [
                                ...
                                "activity" => "Update",
                                "details" => "Billboard Application - {$application->code} was reverted"
                            ];
                        perform_post_curl($lpurl, $lpdata);
                        $session->message("Billboard Application has been reverted");
                        redirect_to("billboard_applications_pending");
                    } else {
                        $message = $reverts->message;
                    }
                } else {
                    $message = "Revert Application Link Broken";
                }
            } else {
                $remarks = "";
            }
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Revert Application</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Revert Pending Application</h4>
                        </div>
                        <div class="card-body card-block">
                            <form action="billboard_application_revert?<?php echo $application->verify_string; ?>" method="POST">
                                <div class="form-group">
                                    <label for="revert_msg">Please state your reason for reverting this Application. <br />
