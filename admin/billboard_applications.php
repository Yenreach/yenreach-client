<?php
    ...
    $gurl = "fetch_all_billboard_applications.php";
            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>All Billboard Applications</h4>
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">All Billboard Applications</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            ?>
                                    <table class="table table-striped table-bordered table-responsive-sm" id="billboard_table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo strftime("%Y.%m.%d", $application->created); ?></td>
                                                        ...
                                                        <td><a class="btn btn-primary" href="billboard_application?<?php echo $application->verify_string; ?>">More Details</a></td>
                                                    </tr>
                                            <?php
                                                }
                                            ?>
