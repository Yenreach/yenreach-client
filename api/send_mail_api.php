<?php
    ...
    if(!empty($post_json)){
        ...
        $mail->content .=                                       '<div class="mktEditable" id="DNT-Header_Logos" style="border-bottom: 3px solid #29ABE1; border-top: 5px solid #0071BC">';
        ...
        $mail->content .=                                                               '<tbody>';
        $mail->content .=                                                                   '<tr>';
        $mail->content .=                                                                       '<td align="left" class="mob_padding" style="padding: 24px 24px 24px 24px; text-align: left">';
        $mail->content .=                                                                           '<a href="https://abelatechnology.com">';
        $mail->content .=                                                                               '<img src="https://yenreach.com/assets/img/logo.png" width="auto" height="45" style="display: inline-block;" alt="Yenreach" border="0">';
        $mail->content .=                                                                           '</a>';
        $mail->content .=                                                                       '</td>';
        $mail->content .=                                                                       '<td align="right" class="mob_padding" style="padding: 24px 24px 24px 24px; color: #0071BC; font-size: 25px; line-height: 30px; font-family: \'Segoe UI\',SUWR,Arial,Sans-Serif; font-weight: 400;">';
        $mail->content .=                                                                           '<a style="text-decoration: none;" href="https://abelatechnology.com.com" target="_blank">';
        $mail->content .=                                                                               '<strong style="font-weight: 400; color: #0071BC;">YENREACH.COM</strong>';
        $mail->content .=                                                                           '</a>';
        $mail->content .=                                                                       '</td>';
        $mail->content .=                                                                   '</tr>';
        $mail->content .=                                                               '</tbody>';
        ...
        $mail->content .=                                                                       '<tbody>';
        $mail->content .=                                                                           '<tr>';
        $mail->content .=                                                                               '<td align="left" class="mob_padding" style="color: #464646; font-size: 15px; font-family: \'Segoe UI\',\'Segoe UI Regular\',SUWR,Arial,Sans-Serif; font-weight: 400; line-height: 20px; padding-left: 24px; padding-right: 24px; text-align: left;">';
        ...
        $mail->content .=                                               '</div>';
        $mail->content .=                                           '</div>';
        $mail->content .=                                           '<table bgcolor="#5E5E5E" width="640" style="width:640px; min-width: 100%" border="0" cellpadding="0" cellspacing="0" align="center" class="mob_padding0 mob_full_width">';
        $mail->content .=                                               '<tbody>';
        $mail->content .=                                                   '<tr>';
        $mail->content .=                                                       '<td class="mob_padding0" style="padding:24px 24px 24px 24px;" bgcolor="#0071BC">';
        ...
        $mail->content .=                                                                                   '</p>';
        $mail->content .=                                                                                   '<p>&nbsp;</p>';
        $mail->content .=                                                                                   '<p style="color: #FEFEFE;">#58, Azikoro Plaza (Authentic Plaza)<br />Opposite NUJ, Ekeki<br />Yenagoa, Bayelsa State</p>';       
        $mail->content .=                                                                               '</div>';
        $mail->content .=                                                                               '<br />';
        $mail->content .=                                                                               '<div>';
        $mail->content .=                                                                                   '<p>';
        $mail->content .=                                                                                       '<a href="https://yenreach.com"><img src="https://yenreach.com/assets/img/ilogo.png" width="auto" height="16" align="left" alt="Yenreach" border="0"></a>';
        $mail->content .=                                                                                   '</p>';
        $mail->content .=                                                                               '</div>';
        $mail->content .=                                                                           '</div>';
        $mail->content .=                                                                       '</td>';
