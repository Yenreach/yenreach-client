...
<main id="main" class="main">
  ...
  <div class="col-12">
    <div class="card recent-sales">
      ...
      <div class="card-body">
        <h5 class="card-title">Notifications | <span><?php echo $total; ?></span></h5>
        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php if($results['status']==0){echo '<span class="badge bg-danger">Pending</span>';} else{echo '<span class="badge bg-success">Treated</span>';} ?></td>
              <td scope="row"><a id="<?php echo $results['id'];?>" href="#" onclick="getInfo(this);" data-bs-toggle="modal" data-bs-target="#exampleModalToggle">Update Status</a></td>
              <td scope="row"><a id="<?php echo $results['id'];?>" href="includes/delete.php?tid=<?php echo $tid;?>&id=<?php echo $results['id'];?>&tran=not">Delete</a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
              ...
              <div class="modal-header">
                ...
                <div id="modal-body" class="modal-body">
                  ...
                  if(isset($_POST['save'])) {
                    ...
                    $insert = mysqli_query($link, "UPDATE `messages` SET `status` = '$status', `lastmodified` = NOW(), `modifiedby` = '$tid' WHERE `id` = '$id'") or die (mysqli_error($link));
                    if($insert) {
