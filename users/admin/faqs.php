...
<main id="main" class="main">
  ...
  <div class="col-12">
    <div class="card recent-sales">
      ...
      <div class="card-body">
        <h5 class="card-title d-flex justify-content-between">FAQs | <?php echo $total; ?> <span style="font-weight: 600;"><a href="#" onclick="getInfo(this);" data-bs-toggle="modal" data-bs-target="#exampleModalToggle">Add Faq</a></span></h5>
        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $results['question']; ?></td>
              ...
              <td scope="row"><a id="<?php echo $results['id'];?>" href="includes/delete.php?tid=<?php echo $tid;?>&id=<?php echo $results['id'];?>&tran=faq">Delete</a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
          ...
          <div class="modal-dialog modal-fullscreen-md-down">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">FAQ</h5>
                ...
                <div id="modal-body" class="modal-body">
                  ...
                  if(isset($_POST['save'])) {
                    ...
                    $insert = mysqli_query($link, "UPDATE `faqs` SET `question` = '$question', `answer`='$answer', `lastmodified` = NOW(), `modifiedby` = '$tid' WHERE `id` = '$id'") or die (mysqli_error($link));
                    if($insert) {
                  ...
                  if(isset($_POST['send'])) {
                    ...
                    $insert = mysqli_query($link, "INSERT INTO `faqs` (`id`, `question`, `answer`, `datecreated`, `lastmodified`, `modifiedby`) VALUES (NULL, '$question', '$answer', NOW(), NOW(), '$tid')") or die (mysqli_error($link));
                    if($insert) {
                      echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
