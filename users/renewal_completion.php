<?php
    ...
    if($initiate_subscription){
        if($initiate_subscription->status == "success"){
            ...
            redirect_to("https://payments.yenreach.com/make_payment?platform=Flutterwave&user_type={$initiate->user_type}&user_string={$initiate->user_string}&reason=business_subscription_renewal&subject={$initiate->verify_string}");
        } else {
