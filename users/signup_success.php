                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p>
                                            Your Signup was successful! Please click on the activation mail sent to <b><?php echo $user->email ?></b>
                                            to activate your Account.
                                        </p>
                                        <p>
                                            In the event that you did not get the mail in your Inbox, please check the Spam Mail Folder.<br />
                                            Still didn't get the Mail? <a href="resend_activation_mail?<?php echo $coded_string; ?>" class="text-primary">Resend Mail</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
